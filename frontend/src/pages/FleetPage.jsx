  ...
  return (
    <div className="p-6" data-testid="fleet-page">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="card">
          <div className="p-4">
            <div className="text-xs text-[var(--text-muted)] uppercase">Fleet Value</div>
            <div className="font-mono text-2xl font-bold text-[var(--primary)]">{formatCurrency(fleetValue)}</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="card">
          <div className="p-4 flex items-center gap-4">
            ...
            <div>
              <div className="text-xs text-[var(--text-muted)] uppercase">Vehicles</div>
        ...
        <div className="card">
          <div className="p-4 flex items-center gap-4">
            <Truck size={28} className="text-[var(--secondary)]" />
            <div>
              <div className="text-xs text-[var(--text-muted)] uppercase">Trailers</div>
        ...
        <div className="card">
          <div className="p-4 flex items-center gap-4">
            ...
            <div>
              <div className="text-xs text-[var(--text-muted)] uppercase">Containers</div>
        ...
        <div className="card">
          <div className="p-4 flex items-center gap-4">
            <Wrench size={28} className={hasMechanic ? 'text-[var(--success)]' : 'text-[var(--danger)]'} />
            <div>
              <div className="text-xs text-[var(--text-muted)] uppercase">Mechanic</div>
              <div className={`font-bold ${hasMechanic ? 'text-[var(--success)]' : 'text-[var(--danger)]'}`}>
